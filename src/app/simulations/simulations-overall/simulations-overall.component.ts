...
@Component({
  selector: 'app-simulations-overall',
  templateUrl: './simulations-overall.component.html',
  styleUrls: ['./simulations-overall.component.scss'],
  providers: [ SecurityService, SimulationService, PortfolioService, CrawlerService ]
})
export class SimulationsOverallComponent implements OnInit {
